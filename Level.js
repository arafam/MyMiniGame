// Level Base Class: Shared Functionality 
class Level {
    constructor(game) {
      this.game = game;
      this.ctx = game.ctx;
    ...
    updateExplosions() {
      // Simple explosion animation from sprite sheet
